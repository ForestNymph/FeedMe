...
class ArchivedProductDB_SQL extends SQLiteOpenHelper {
    ...
    static final String TABLE_ARCHIVED = "archived";
    static final String TABLE_ARCHIVED_DATE_KCAL = "archived_date_kcal";
